                ...
                <div class="col-md-6 col-lg-6 col-xl-12">
                    <div class="card bg-primary">
                        <div class="card-body row">
                            ...
                            <div class="col">
                                <img class="img-fluid" src="{{asset('dist/assets/images/interview.svg')}}" alt="interview">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-body">
                            <div class="flex-grow-1">
                                <div class="py-2 d-flex align-items-center border-bottom flex-wrap">
                                    <div class="d-flex align-items-center flex-fill">
                                        <img class="avatar lg rounded-circle img-thumbnail"
                                            src="{{asset('dist/assets/images/lg/avatar2.jpg')}}" alt="profile">
                                ...
                                <div class="py-2 d-flex align-items-center border-bottom flex-wrap">
                                    <div class="d-flex align-items-center flex-fill">
                                        <img class="avatar lg rounded-circle img-thumbnail"
                                            src="{{asset('dist/assets/images/lg/avatar9.jpg')}}" alt="profile">
                                        <div class="d-flex flex-column ps-3">
                                ...
                                <div class="py-2 d-flex align-items-center border-bottom flex-wrap">
                                    <div class="d-flex align-items-center flex-fill">
                                        <img class="avatar lg rounded-circle img-thumbnail"
                                            src="{{asset('dist/assets/images/lg/avatar12.jpg')}}" alt="profile">
                                        <div class="d-flex flex-column ps-3">
                                ...
                                <div class="py-2 d-flex align-items-center border-bottom flex-wrap">
                                    <div class="d-flex align-items-center flex-fill">
                                        <img class="avatar lg rounded-circle img-thumbnail"
                                            src="{{asset('dist/assets/images/lg/avatar8.jpg')}}" alt="profile">
                                        <div class="d-flex flex-column ps-3">
                                ...
                                <div class="py-2 d-flex align-items-center border-bottom flex-wrap">
                                    <div class="d-flex align-items-center flex-fill">
                                        <img class="avatar lg rounded-circle img-thumbnail"
                                            src="{{asset('dist/assets/images/lg/avatar7.jpg')}}" alt="profile">
                                        <div class="d-flex flex-column ps-3">
                                ...
                                <div class="py-2 d-flex align-items-center border-bottom flex-wrap">
                                    <div class="d-flex align-items-center flex-fill">
                                        <img class="avatar lg rounded-circle img-thumbnail"
                                            src="{{asset('dist/assets/images/lg/avatar3.jpg')}}" alt="profile">
                                        <div class="d-flex flex-column ps-3">
