...
<head>
    ...
    <!-- project css file  -->
    <link rel="stylesheet" href="{{asset('dist/assets/css/my-task.style.min.css')}}">
</head>
<body>
                    ...
                    <div class="h-right d-flex align-items-center mr-5 mr-lg-0 order-1">
                        <div class="d-flex">
                            ...
                            <div class="avatar-list avatar-list-stacked px-3">
                                <img class="avatar rounded-circle" src="{{asset('dist/assets/images/xs/avatar2.jpg')}}" alt="">
                                <img class="avatar rounded-circle" src="{{asset('dist/assets/images/xs/avatar1.jpg')}}" alt="">
                                <img class="avatar rounded-circle" src="{{asset('dist/assets/images/xs/avatar3.jpg')}}" alt="">
                                <img class="avatar rounded-circle" src="{{asset('dist/assets/images/xs/avatar4.jpg')}}" alt="">
                                <img class="avatar rounded-circle" src="{{asset('dist/assets/images/xs/avatar7.jpg')}}" alt="">
                                <img class="avatar rounded-circle" src="{{asset('dist/assets/images/xs/avatar8.jpg')}}" alt="">
                        ...
                        <div class="dropdown user-profile ml-2 ml-sm-3 d-flex align-items-center zindex-popover">
                            ...
                            <a class="nav-link dropdown-toggle pulse p-0" href="#" role="button" data-bs-toggle="dropdown" data-bs-display="static">
                                <img class="avatar lg rounded-circle img-thumbnail" src="{{asset('dist/assets/images/profile_av.png')}}" alt="profile">
                            </a>
...
<script src="{{asset('dist/js/page/hr.js')}}"></script>
</body>
</html> 